...
//		if (radius > 0.1) {
		_freeEyeX = _freeCenterX + ((radius - 200) * cos(_hAngle * 3.14 / 180) * sin(_vAngle * 3.14 / 180));
		_freeEyeZ = _freeCenterZ + ((radius - 200) * sin(_hAngle * 3.14 / 180) * sin(_vAngle * 3.14 / 180));
		_freeEyeY = _freeCenterY + ((radius - 200) * cos(_vAngle * 3.14 / 180));
//		}
	}
	else if (button == 4) {
	GLfloat radius = sqrt((_freeCenterX - _freeEyeX) * (_freeCenterX - _freeEyeX) + (_freeCenterY - _freeEyeY) * (_freeCenterY - _freeEyeY) + (_freeCenterZ - _freeEyeZ) * (_freeCenterZ - _freeEyeZ));
